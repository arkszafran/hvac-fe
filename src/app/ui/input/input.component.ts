...
export class UiInputComponent implements ControlValueAccessor {
  ...
  protected readonly inputClasses = computed(() =>
    classNames(
      'ui-focus-ring block w-full rounded-[1.35rem] border border-black/6 bg-white/88 px-4 py-3.5 text-[15px]/6 text-text-main shadow-[inset_0_1px_0_rgb(255_255_255/0.78),0_1px_2px_rgb(15_23_42/0.04)] backdrop-blur-xl transition duration-200 placeholder:text-text-muted/80 disabled:cursor-not-allowed disabled:border-transparent disabled:bg-surface-muted disabled:text-text-muted',
      this.error()
